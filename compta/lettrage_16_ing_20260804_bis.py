# -*- coding: utf-8 -*-
"""
LETTRAGE ING 04/08/2026 (BIS) -- 2e passe sur les lignes BNK1 restantes apres
...
Usage : python lettrage_16_ing_20260804_bis.py            (DRY-RUN, rien ecrit)
        python lettrage_16_ing_20260804_bis.py --apply
"""
...
CASES = [
    {"bsl_ids": [20063], "acc": ACC_400000, "docs": ["INV/2026/02576"], "allow_partial": True,
     "label": "VENTE-PRIVEE.COM - INV/2026/02576 partiel (2.426,43 sur 2.470,08, retenue 43,65)"},
    {"bsl_ids": [20060], "acc": ACC_400000, "docs": ["INV/2026/03368"], "allow_partial": True,
     "label": "WDISTRI/CM Shopping Woluwe - INV/2026/03368 partiel (336,00 sur 351,40, reste 15,40)"},
]
...
def create_writeoff(partner_id, amount_abs, debit_acc, credit_acc, label):
    vals = {
        ...
        "date": TODAY,
        "ref": f"Write-off ecart reglement lettrage ING 04/08 (bis) - {label}",
        "line_ids": [

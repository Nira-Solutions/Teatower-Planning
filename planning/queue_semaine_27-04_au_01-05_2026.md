...
- **Ajouté mardi** : AD Delhaize Fernelmont #2952 (demande Tamara 10/04 : remplissage + swap 3 SKU → thés glacés).
- **Mercredi** : trou Embourg→Remouchamps accepté (Tilff retiré, pas de candidat OK mercredi dans la zone).
- **Les 2 commandes Hyper Carrefour encodées par Nicolas 22/04** (S05457 Boncelles + S05459 Fléron) **sont pour S19** (livraison merchandiser sem. 04-08/05) — voir `queue_semaine_04-05_au_08-05_2026.md`.
...
## Mardi 28/04 — Marche / Fernelmont (1 indispo + 2 visites)
...
| 12:15-12:45 | CM Marche (Mardis) | Avenue du Monument 1, 6900 Marche | — | — | Visite | Tier C, 27j. À 5 min de HERION. |
| 13:45-14:30 | **AD Delhaize Fernelmont** (Fernel-Dis) | 5380 Fernelmont | **Tamara Geurts** | +32 81 83 04 55 | Visite + **swap 3 SKU** | **Demande Tamara 10/04** : remplissage complet + STOPPER 3 réf pour introduire les THÉS GLACÉS. Email info@adfernelmont.be. Tier B, 29j. |

**Route** : Baillonville → HERION Marche (30 min) → pneus 09:30-12:00 → CM Marche (5 min) → déjeuner rapide → Fernelmont (50 min via N4+Namur-Nord) → retour Baillonville (35 min via N63+N4) → ~15:10. [Google Maps](https://www.google.com/maps/dir/Baillonville+5377/Rue+Saint+Isidore+1B+6900+Marche-en-Famenne/Avenue+du+Monument+1+6900+Marche-en-Famenne/AD+Delhaize+5380+Fernelmont/Baillonville+5377)

**Retirés v4 (revisites S17)** : Delhaize Marche (S17 jeu 24/04), AD Rochefort (S17 mer 23/04), ITM Assesse (S17 lun 21/04 — SO S05452 412€ confirmé 21/04).
...
- Assesse (A, 27j — revisite S17 retirée v4, SO S05452 412€ 21/04 livré)
